...
REM
REM ASCII only below: cmd.exe reads .bat in the OEM codepage, so a UTF-8 dash
REM here decoded to mojibake and cmd parsed the line as a command named "M".
REM Noise rather than failure, but it makes every run look broken.
